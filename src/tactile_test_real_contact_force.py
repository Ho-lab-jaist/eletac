...
img_folder = '/media/tatu/SSDIOTOUCH2/Tuan/eletac/real_contact/test/test/'
...
with torch.no_grad():
    ...
    print('distance: ', np.linalg.norm(estimated_positions_displacement[0][:2]-truth[:2]))
    # print('mae: ', np.mean(np.abs(estimated_positions_displacement - truth)))
